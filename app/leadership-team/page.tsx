...
export default function LeadershipTeamPage() {
  ...
  const [operationsLead] = supportingLeadership;

  return (
    <>
      <PageHero
        eyebrow="Leadership & International Advisory Council"
        title="International advisory guidance and scientific direction."
        intro="This section introduces the International Advisory Council of Boston Scientific Research Center, followed by the center's scientific direction and strategic coordination."
        compact
      />
      ...
      <section className="section section--tight-top">
        <div className="shell">
          <div className="two-up">
            ...
            <article className="card">
              <p className="eyebrow">Scientific Direction</p>
              <h2 className="section-title section-title--small">Center direction and strategic stewardship.</h2>
              <p>
                Scientific direction presents the academic leadership guiding the center's
                scholarly posture, research culture, and developing collaborations.
              </p>
            </article>
          </div>
        </div>
